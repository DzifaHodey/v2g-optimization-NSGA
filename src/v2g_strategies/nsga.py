...
from utils import Params, get_number_of_cycles, update_battery_state
from constants import *

# NSGA-II V2G CHARGING STRATEGY
...
def run_nsga(params: Params):
    ...
    best_solution = pareto_solutions[best_idx].tolist()
    ...
    results = {
        ...
        "nsga_charging_schedule": best_solution,
        "nsga_energy_cost": energy_cost,
        "nsga_batt_deg_cost": batt_deg_cost,
        "nsga_total_cost": energy_cost + batt_deg_cost,
        "nsga_net_load": best_net_load,
        "nsga_socs": best_socs,
        "nsga_sohs": best_sohs,
        "nsga_dods": best_dods,
        "nsga_energy_prices": lambda_e_s
    }
    return results
